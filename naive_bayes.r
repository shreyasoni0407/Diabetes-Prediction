...
#------------naive bayes for boruta over------------------------
naive_bayes_model <- naive_bayes(Class ~ ., data = Boruta_Oversampled )
predicted <- predict(naive_bayes_model, newdata = ts)
cm <- table(predicted, ts$Class)
print(cm)
accuracy <- sum(diag(cm)) / sum(cm)
cat("Overall Accuracy: ", round(accuracy * 100, 3), "%\n")
predicted_probabilities <- predict(naive_bayes_model, newdata = ts, type = "response")
roc_score=roc.curve(ts$Class, predicted_probabilities, levels = levels(ts$Class))
roc_score


#----------------naive bayes for boruta under ----------------------
naive_bayes_model <- naive_bayes(Class ~ ., data = Boruta_Undersampled )
predicted <- predict(naive_bayes_model, newdata = ts)
cm <- table(predicted, ts$Class)
print(cm)
accuracy <- sum(diag(cm)) / sum(cm)
...
#----------naive bayes for lasso over--------------------------------

naive_bayes_model <- naive_bayes(Class ~ ., data = Lasso_Oversample)
predicted <- predict(naive_bayes_model, newdata = ts)
cm <- table(predicted, ts$Class)
print(cm)
accuracy <- sum(diag(cm)) / sum(cm)
...
roc_score=roc.curve(ts$Class, predicted_probabilities, levels = levels(ts$Class))
roc_score
#---------------------naive bayes for lasso under------------------

naive_bayes_model <- naive_bayes(Class ~ ., data = Lasso_Undersample)
predicted <- predict(naive_bayes_model, newdata = ts)
cm <- table(predicted, ts$Class)
print(cm)
accuracy <- sum(diag(cm)) / sum(cm)
...
roc_score=roc.curve(ts$Class, predicted_probabilities, levels = levels(ts$Class))
roc_score
#---------------nb for elasticnet over---------------

naive_bayes_model <- naive_bayes(Class ~ ., data = ElasticNet_Oversample)
predicted <- predict(naive_bayes_model, newdata = ts)
cm <- table(predicted, ts$Class)
print(cm)
accuracy <- sum(diag(cm)) / sum(cm)
...
#---------------nb for elasticnet under---------------

naive_bayes_model <- naive_bayes(Class ~ ., data = ElasticNet_UnderSample)
predicted <- predict(naive_bayes_model, newdata = ts)
cm <- table(predicted, ts$Class)
print(cm)
accuracy <- sum(diag(cm)) / sum(cm)
